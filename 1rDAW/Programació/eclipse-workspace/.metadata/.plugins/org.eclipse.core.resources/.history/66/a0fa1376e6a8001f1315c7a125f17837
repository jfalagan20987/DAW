...
public class CompteBancari {
	...
	public void ingressarDiners() {
		...
		System.out.println("S'han ingressat "+saldoIngressat+" euros al compte bancari de "+nomTitular+" amb DNI "+dniTitular+".");
	}
	...
	public void retirarDiners() {
		...
		saldo -= saldoRetirat;
		System.out.println("S'han retirat "+saldoRetirat+" euros al compte bancari de "+nomTitular+" amb DNI "+dniTitular+".");
	}
	
	public void mostrarSaldo() {
		System.out.println("Al compte de "+nomTitular+", amb DNI "+dniTitular+", hi ha un total de "+saldo+" euros.");
	}
