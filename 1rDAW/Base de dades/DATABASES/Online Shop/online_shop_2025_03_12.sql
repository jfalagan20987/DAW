...
CREATE DEFINER=`root`@`localhost` PROCEDURE `placeOrder` ()   BEGIN
	...
	WHERE product_id = var_product_id;
       ...
       SET var_order_number = FLOOR(10000+RAND()*999999+1);
	
	-- Place order
	INSERT INTO orders (order_number, customer_id, product_id, quantity, unit_price, payment_id, address_id)
	SELECT (var_order_number, var_customer_id, var_product_id, var_quantity, var_unit_price, 
        getPaymentId(var_customer_id), getAddressId(var_customer_id)) 
        FROM shopping_cart WHERE customer_id = var_customer_id;
...
(119557, 1, 10, 1, 1089.00, '2025-03-12 18:59:27', 2, 1),
(130154, 7, 6, 1, 44.99, '2025-03-12 18:59:27', 2, 11),
(547863, 6, 25, 9, 20.00, '2025-03-12 18:51:28', 1, 10),
(611426, 10, 10, 4, 1089.00, '2025-03-12 18:56:15', 1, 15),
(657270, 5, 11, 6, 274.98, '2025-03-12 18:59:27', 1, 9),
(818075, 7, 14, 5, 10.00, '2025-03-12 18:59:27', 3, 11);
