...
CREATE DEFINER=`root`@`localhost` PROCEDURE `placeOrder` ()   BEGIN
	...
	DECLARE var_product_id INT;
	DECLARE var_quantity INT;
	DECLARE var_unit_price DECIMAL (10,2);
	
	-- Select random row
	SELECT customer_id, product_id, quantity INTO var_customer_id, var_product_id, var_quantity
	FROM shopping_cart
	ORDER BY RAND()
	LIMIT 1;
	
	-- Get unit price
	SELECT unit_price INTO var_unit_price
	FROM products
	WHERE product_id = var_product_id;
	
	-- Place order
	INSERT INTO orders (customer_id, product_id, quantity, unit_price)
	VALUES (var_customer_id, var_product_id, var_quantity, var_unit_price);
	
	-- Remove row from shopping_cart
	DELETE FROM shopping_cart
    WHERE customer_id = var_customer_id AND
    	product_id = var_product_id AND
...
(286955, 6, 10, 2, 1089.00, '2025-01-14 18:37:24'),
...
(478965, 1, 9, 9, 99.70, '2025-03-11 18:05:32'),
...
(3, 4, 6, '2025-03-11 18:42:17'),
(3, 15, 4, '2025-03-11 18:42:34'),
(3, 23, 4, '2025-03-11 18:42:34'),
(3, 25, 3, '2024-12-11 18:53:12'),
(4, 1, 1, '2024-12-11 18:53:12'),
(4, 2, 1, '2024-12-11 18:53:12'),
(4, 9, 8, '2025-03-11 18:42:17'),
(4, 11, 6, '2025-03-11 18:42:17'),
(5, 11, 6, '2025-03-11 18:42:34'),
(5, 22, 1, '2025-03-11 18:42:34'),
(5, 24, 8, '2025-03-11 18:42:17'),
(6, 25, 9, '2025-03-11 18:42:17'),
(7, 3, 1, '2025-03-11 18:42:17'),
(7, 6, 1, '2024-12-11 18:53:12'),
(7, 14, 5, '2025-03-11 18:42:34'),
(7, 17, 2, '2024-12-11 18:53:12'),
(7, 18, 1, '2024-12-11 18:53:12'),
(7, 19, 7, '2025-03-11 18:42:34'),
(8, 3, 1, '2024-12-11 18:53:12'),
(8, 4, 1, '2024-12-11 18:53:12'),
(8, 8, 1, '2024-12-11 18:53:12'),
(8, 9, 7, '2025-03-11 18:42:34'),
(8, 10, 19, '2025-03-11 18:42:17'),
(8, 23, 6, '2025-03-11 18:42:34'),
(9, 2, 1, '2024-12-11 18:53:12'),
(9, 6, 5, '2025-03-11 18:42:34'),
(9, 7, 10, '2025-03-11 18:42:17'),
(9, 9, 5, '2025-03-11 18:42:34'),
(9, 16, 2, '2024-12-11 18:53:12'),
(9, 21, 6, '2025-03-11 18:42:17'),
(9, 24, 3, '2025-03-11 18:42:17'),
(10, 1, 3, '2025-03-11 18:42:17'),
(10, 4, 1, '2025-03-11 18:42:17'),
(10, 5, 2, '2025-03-11 18:42:34'),
(10, 6, 16, '2025-03-11 18:42:34'),
(10, 8, 9, '2025-03-11 18:42:34'),
(10, 10, 4, '2024-12-11 18:53:12'),
(10, 12, 7, '2025-03-11 18:42:34'),
(10, 15, 9, '2025-03-11 18:42:17'),
(10, 25, 4, '2025-03-11 18:42:17');
