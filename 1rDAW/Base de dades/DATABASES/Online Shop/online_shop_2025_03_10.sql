...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2025 at 05:20 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `rand_ins_shopping_cart` (IN `var_rows` INT)   BEGIN
	FOR i IN 1..var_rows
	DO
		INSERT INTO test_shopping_cart (customer_id, product_id, quantity)
		VALUES ((FLOOR(RAND() * 10+1)), (FLOOR(RAND() * 25+1)), (FLOOR(RAND() * 10+1)));
	END FOR;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `test_rand_ins_shopping_cart` (IN `var_rows` INT)   BEGIN
	...
	FOR i IN 1..var_rows
	DO
		SET var_customer_id = FLOOR(RAND() * 10+1);
		SET var_product_id = FLOOR(RAND() * 25+1);
		SET var_quantity = FLOOR(RAND() * 10+1);
		
		IF var_customer_id AND var_product_id = test_shopping_cart.customer_id AND test_shopping_cart.product_id THEN
			UPDATE test_shopping_cart
...
(28695, 6, 10, 2, 1089.00, '2025-01-14 18:37:24'),
(117845, 1, 10, 1, 1089.00, '2024-12-09 08:52:41'),
(117845, 1, 15, 2, 28.99, '2024-12-09 08:52:41'),
(120369, 2, 20, 5, 19.99, '2024-12-09 16:28:07'),
(120587, 5, 13, 4, 20.00, '2025-01-14 18:37:24'),
(120587, 5, 22, 5, 50.00, '2025-01-14 18:37:24'),
(157751, 7, 6, 1, 44.99, '2024-12-10 18:59:21'),
(157751, 7, 17, 1, 50.00, '2024-12-10 18:59:21'),
(157751, 7, 18, 1, 20.00, '2024-12-10 18:59:21'),
(193544, 4, 19, 1, 7.99, '2024-12-11 19:44:47'),
(193544, 4, 20, 1, 19.99, '2024-12-11 19:44:47'),
(357220, 9, 2, 1, 380.00, '2024-12-10 22:15:48'),
(357220, 9, 16, 2, 99.99, '2024-12-10 22:15:48'),
(378002, 3, 25, 3, 20.00, '2024-12-09 19:34:45'),
(459632, 3, 6, 2, 44.99, '2025-01-08 18:59:08'),
(464402, 8, 8, 1, 124.99, '2024-12-10 19:01:53'),
(489199, 4, 1, 1, 450.00, '2024-12-10 16:13:10'),
(774205, 9, 1, 1, 450.00, '2025-01-14 18:33:01'),
(774205, 9, 4, 3, 76.99, '2025-01-14 18:33:01'),
(811365, 10, 10, 4, 56.99, '2024-12-11 17:39:11');
...
--
-- Table structure for table `test_shopping_cart`
--

CREATE TABLE `test_shopping_cart` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `quantity` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `test_shopping_cart`
--

INSERT INTO `test_shopping_cart` (`customer_id`, `product_id`, `quantity`, `inserted_on`) VALUES
(1, 6, 2, '2025-03-10 15:50:59'),
(1, 10, 10, '2025-03-10 15:50:59'),
(1, 12, 2, '2025-03-10 16:05:21'),
(2, 1, 7, '2025-03-10 15:53:25'),
(2, 3, 1, '2025-03-10 15:59:59'),
(2, 4, 3, '2025-03-10 15:50:59'),
(2, 15, 4, '2025-03-10 15:53:25'),
(2, 18, 1, '2025-03-10 15:50:59'),
(2, 22, 9, '2025-03-10 15:53:25'),
(4, 6, 2, '2025-03-10 15:59:59'),
(4, 10, 9, '2025-03-10 16:05:21'),
(4, 15, 8, '2025-03-10 16:05:21'),
(4, 25, 8, '2025-03-10 15:59:59'),
(5, 6, 8, '2025-03-10 15:53:25'),
(5, 11, 9, '2025-03-10 16:05:21'),
(5, 17, 9, '2025-03-10 16:05:21'),
(6, 6, 5, '2025-03-10 16:05:21'),
(6, 18, 10, '2025-03-10 15:50:59'),
(7, 7, 4, '2025-03-10 15:59:59'),
(8, 3, 3, '2025-03-10 15:50:59'),
(8, 6, 8, '2025-03-10 15:53:25'),
(8, 16, 9, '2025-03-10 15:59:59'),
(8, 25, 7, '2025-03-10 15:50:59'),
(9, 11, 4, '2025-03-10 15:59:59'),
(9, 13, 9, '2025-03-10 15:50:59'),
(9, 19, 3, '2025-03-10 15:59:59'),
(10, 2, 6, '2025-03-10 16:05:21'),
(10, 10, 10, '2025-03-10 16:05:21'),
(10, 14, 1, '2025-03-10 15:53:25'),
(10, 20, 3, '2025-03-10 15:50:59');
...
--
-- Indexes for table `test_shopping_cart`
--
ALTER TABLE `test_shopping_cart`
  ADD PRIMARY KEY (`customer_id`,`product_id`),
  ADD KEY `product_id` (`product_id`);
...
--
-- Constraints for table `test_shopping_cart`
--
ALTER TABLE `test_shopping_cart`
  ADD CONSTRAINT `test_shopping_cart_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`),
  ADD CONSTRAINT `test_shopping_cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
COMMIT;
