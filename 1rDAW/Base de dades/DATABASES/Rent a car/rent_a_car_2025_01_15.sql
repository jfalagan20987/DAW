...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2025 at 08:51 PM
...
--
-- Stand-in structure for view `reservations_total_price`
-- (See below for the actual view)
--
CREATE TABLE `reservations_total_price` (
