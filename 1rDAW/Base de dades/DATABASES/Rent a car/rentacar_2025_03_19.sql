...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `rentacarEvent` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-03-18 18:14:16' ENDS '2025-04-04 18:14:16' ON COMPLETION PRESERVE ENABLE DO CALL addReservation()$$
