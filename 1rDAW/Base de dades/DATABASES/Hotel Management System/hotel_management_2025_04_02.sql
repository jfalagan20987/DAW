...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2025 at 07:14 PM
...
--
ALTER TABLE `reservations`
  MODIFY `reservation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `reservationsEvent` ON SCHEDULE EVERY 5 SECOND STARTS '2025-04-01 18:54:17' ENDS '2025-04-03 18:54:17' ON COMPLETION PRESERVE ENABLE DO CALL randomReservationInsert()$$
